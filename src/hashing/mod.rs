...
//     let clean = |x: &mut Vec<u8>| {
//         for i in &mut x.iter_mut() {
//             *i = 0;
//         }
//     };
...
//     ret = update(
//         ctx,
//         &ctx.hmac_ctx[..(ctx.md_info.block_size as usize)].to_vec(),
//         ctx.md_info.block_size as usize,
//     );
//     if ret != 0 {
//         clean(&mut final_key);
//     }
...
//         ],
//         [
//             0x32, 0xEC, 0x01, 0xEC, 0x4A, 0x6D, 0xAC, 0x72, 0xC0, 0xAB, 0x96, 0xFB, 0x34, 0xC0,
//             0xB5, 0xD1,
//         ],
//         [
...
//         ],
//         [
//             0xAB, 0x4F, 0x49, 0x6B, 0xFB, 0x2A, 0x53, 0x0B, 0x21, 0x9F, 0xF3, 0x30, 0x31, 0xFE,
//             0x06, 0xB0,
//         ],
//         [
//             0x4E, 0x8D, 0xDF, 0xF3, 0x65, 0x02, 0x92, 0xAB, 0x5A, 0x41, 0x08, 0xC3, 0xAA, 0x47,
//             0x94, 0x0B,
//         ],
//         [
//             0xDA, 0x33, 0xDE, 0xF2, 0xA4, 0x2D, 0xF1, 0x39, 0x75, 0x35, 0x28, 0x46, 0xC3, 0x03,
//             0x38, 0xCD,
//         ],
//         [
...
//             0x13, 0x75, 0x8b, 0x95, 0x34, 0xbf, 0xb3, 0x8d, 0x85, 0x04, 0x57, 0x81, 0x46, 0x13,
//             0xb0, 0xc1,
//         ];
...
//         assert_eq!(
//             cmp::Ordering::Equal,
//             compare(output.as_ref(), &actual_output)
//         );
//     }
// }
